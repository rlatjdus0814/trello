    ...
    <div className="root">
      <div className="top">
        <div className="top-left">
          <div className="top-left-home"><a href="#" class="icon"><img src={home} alt="home" /></a></div>
          <div className="top-left-boards"><a href="#" class="icon"><img src={trello} alt="boards" /></a></div>
          <div className="top-left-search"><a href="#" class="icon"><img src={search} alt="search" /></a></div>
        </div>
        <div className="top-center">
          <div className="top-center logo"><a href="#" class="icon"><img src={trello} alt="trello" /> Trello</a></div>
        </div>
        <div className="top-right">
          <div className="top-right-create"><a href="#" class="icon"><img src={plus} alt="create" /></a></div>
          <div className="top-right-info"><a href="#" class="icon"><img src={info} alt="info" /></a></div>
          <div className="top-right-alarm"><a href="#" class="icon"><img src={alarm} alt="noti" /></a></div>
          <div className="top-right-profile"><a href="#" class="profile"><span>김</span></a></div>
        </div>
      </div>
